...
def objective_fn(theta):
    val1_1 = quantum_circuit_no_Z(theta=theta,num_of_qubits=num_of_qubits,start_state=start_state)
    val1_2 = quantum_circuit_Z(theta=theta,num_of_qubits=num_of_qubits,start_state=start_state)
